...
//         IMAGE_BASE_URL=https://semihveli66-tech.github.io/Bot-/mailing
//
...
const IMAGE_BASE = (process.env.IMAGE_BASE_URL || 'https://semihveli66-tech.github.io/Bot-/mailing').replace(/\/$/, '');
